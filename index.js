...
app.post("/nodemail", async (req, res) => {
  ...
  const transporter = NodeMailer.createTransport({
    service: "gmail",
    auth: {
      user: "doubletroubletraining24@gmail.com",
      pass: "yhdioawcgmsjgwev",
    },
  });
  let product_cards = ``;
  ...
  const options = {
    from: "Double Trouble Training <doubletroubletraining24@gmail.com>",
    to: [email, "doubletroubletrainingorders@gmail.com"],
